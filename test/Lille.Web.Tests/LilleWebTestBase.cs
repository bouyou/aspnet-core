...
{
    public abstract class LilleWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LilleWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LilleWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LilleDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LilleDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LilleDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LilleDbContext, Task<T>> func)
        {
            T result;
